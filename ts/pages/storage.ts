...
export async function uploadImageAsInputFileRespownse(image: File) {
  const file = image;
...
export async function getImageByName(imageName: string) {
...
export async function deleteImageFromDb(imageName: string) {
...
export async function deleteAllImagesFromDb(arrayOfImagesName: string[]) {
